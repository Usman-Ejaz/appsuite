...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Multi-tenant platform API covering Identity (companies, users, roles, API keys), CMS, and Ecommerce. Endpoints are grouped by domain and require authentication unless noted otherwise.',
    ],
