...
class CreateRequest extends FormRequest
{
    ...
    {
        return Gate::allows('permission', EcommercePermission::CAMPAIGN_CREATE->value);
    }
    ...
    public function rules(): array
    {
        return [
             ...
             * @example black-friday-2026
             */
            'slug' => ['required', 'string', 'max:255', Rule::unique('campaigns')->where('company_id', $this->user()?->getCompanyId())],
