...
class CreateRequest extends FormRequest
{
    ...
    {
        return Gate::allows('permission', EcommercePermission::CUSTOMER_CREATE->value);
    }
    ...
    public function rules(): array
    {
        return [
             ...
             */
            'email' => ['required', 'email', 'max:255', Rule::unique('customers')->where('company_id', $this->user()?->getCompanyId())],
